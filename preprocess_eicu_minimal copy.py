...
OUT = os.path.join(ROOT, "eicu_processed")
...
# 只拿前 500 个 sepsis 病人，先让流程跑通
sepsis_ids = sepsis_ids[:500]
...
merged["reward"] = 0.0
merged.loc[merged["done"] == 1, "reward"] = np.where(
    merged["dead"] == 1, -24.0, 24.0
)
